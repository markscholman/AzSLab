...
$NewWDSToolkitScript = Get-Content C:\Install\Scripts\DeployAzureStackPOC.ps1 -Raw
...
$bootImagePath =  "$env:SystemDrive:\Install\BootImage\boot.wim"
...
Copy-Item C:\Install\Scripts\DeployAzureStackPOC.psm1 $mountPath -Force  
Copy-Item C:\Install\Scripts\startnet.cmd $mountPath\windows\system32 -Force
